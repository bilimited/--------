...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='day:这节课在周几(1-7)\r\nstart:这节课在第几节开始(1-11)\r\nend:这节课在第几节结束(1-11)\r\nroom:这节课在哪个教室\r\nnote:这节课的备注\r\ncapacity:这节课可选的最大人数';

-- 数据导出被取消选择。

-- 导出  函数 ts1.course_stunumber 结构
DROP FUNCTION IF EXISTS `course_stunumber`;
DELIMITER //
...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  PRIMARY KEY (`sno`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='学生档案，包括该学生的学号等信息。';
...
CREATE TABLE IF NOT EXISTS `teacher` (
  ...
  PRIMARY KEY (`tno`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='教师档案';
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='portraitid是头像的id\r\n';
