...
CREATE TABLE IF NOT EXISTS `student_class` (
  ...
  KEY `cno` (`cno`),
  CONSTRAINT `cno` FOREIGN KEY (`cno`) REFERENCES `class` (`cno`),
  CONSTRAINT `sno` FOREIGN KEY (`sno`) REFERENCES `student` (`sno`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='student to class';

-- 数据导出被取消选择。

-- 导出  表 ts.teacher 结构
CREATE TABLE IF NOT EXISTS `teacher` (
  `tid` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '',
